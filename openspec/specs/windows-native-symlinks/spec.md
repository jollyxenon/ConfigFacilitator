# windows-native-symlinks Specification

## Purpose
Define native Windows hard-link behavior for ConfigFacilitator while preserving the project's no-fallback safety model.
## Requirements
### Requirement: Native Windows uses real hard links for file mappings
...
### Requirement: Windows hard-link failure diagnostics are actionable
